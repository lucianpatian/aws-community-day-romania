...
const MobileMenu = ({ isOpen, onButtonClick }) => {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <m.nav
        className="safe-paddings fixed inset-0 z-[-1] mt-[100px] hidden overflow-x-hidden overflow-y-hidden bg-black bg-opacity-100 px-8 pb-5 pt-[72px] lg:flex lg:flex-col lg:justify-between"
        initial="from"
        animate={controls}
        variants={variants}
      >
